    ...
    >
      ...
      >
        ...
        <motion.div 
          ...
          className="w-1/2 flex flex-col items-center justify-center space-y-8 bg-gradient-to-br from-indigo-500 to-purple-500 p-10"
        >
          <motion.div 
    ...
    <div className="w-full max-w-md space-y-6">
      ...
      <form className="space-y-4">
        <motion.div 
          ...
          className="relative"
        >
          <FaUserCircle className="absolute top-1/2 transform -translate-y-1/2 left-3 text-gray-500" />
          <input
            type="email"
            placeholder="Email"
            onChange={(e) => setEmail(e.target.value)}
            className="w-full p-3 pl-10 bg-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </motion.div>
        <motion.div 
          initial={{ x: -20, opacity: 0 }}
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      ...
      <form className="space-y-4">
        ...
        {[
          { type: 'email', placeholder: 'Email', icon: <FaUserCircle />, onChange : (e: any) => {setEmail(e.target.value)}  },
          { type: 'password', placeholder: 'Password', icon: <FaLock />, onChange : (e: any) => {setPassword(e.target.value)} },
          { type: 'password', placeholder: 'Confirm Password', icon: <FaLock />, onChange : (e: any) => {setConfirmPassword(e.target.value)} },
          { type: 'email', placeholder: 'Emergency Contact (email)', icon: <FaUserCircle />, onChange : (e: any) => {setEmergencyContact(e.target.value)} },
        ].map((input, index) => (
          <motion.div
        ...
        >
          <input
            ...
            className="w-full p-3 bg-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </motion.div>
        <motion.button
          whileHover={{ scale: 1.02 }}
